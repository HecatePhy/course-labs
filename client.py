...
# first_seq
# last_seq
init_order = (0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15)
...
def unwrap_slices(recvmsg):
	...
	ts_6packet = recvmsg[12:len(recvmsg)]
	ts_packet = []
	for i in range(0, len(ts_6packet) / TS_PACKET_LENGTH):
		ts_packet.append(ts_6packet[TS_PACKET_LENGTH*i : min((i + 1) * TS_PACKET_LENGTH, len(ts_6packet))])
...
def cal_order(serial_num, seq_num):
	...
	serial_num2 = serial_num1 / 16 + init_order[serial_num1 % 16]
	return serial_num2
	'''
	pass
